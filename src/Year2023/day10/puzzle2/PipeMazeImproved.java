package Year2023.day10.puzzle2;
...
public class PipeMazeImproved {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = size/4; i < size/4+size/2; i++) {
            for (int j = size/4; j < size/4+size/2; j++) {
                if (distances[i][j] == 0) total++;
            }
        }
        System.out.println("There are " + total + " closed areas.");
    }
